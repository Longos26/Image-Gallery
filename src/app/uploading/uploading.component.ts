...
export class UploadingComponent implements OnInit {
  ...
  initializeCanvas(): void {
    ...
    canvas.addEventListener('mouseout', this.endCrop.bind(this)); // Add this to fix the cropping issue
  ...
  applyCrop(): void {
    ...
    this.editImageUrl = canvas.toDataURL('image/png'); // Update the edited image URL
  }
